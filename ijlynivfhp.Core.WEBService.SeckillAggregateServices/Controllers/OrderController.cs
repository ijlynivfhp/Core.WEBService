...
using ijlynivfhp.Core.WEBService.Commons.Distributes;
using ijlynivfhp.Core.WEBService.Commons.Exceptions;
using ijlynivfhp.Core.WEBService.Commons.Users;
using ijlynivfhp.Core.WEBService.Commons.Utils;
using ijlynivfhp.Core.WEBService.OrderServices.Models;
using ijlynivfhp.Core.WEBService.SeckillAggregateServices.Caches.SeckillStock;
using ijlynivfhp.Core.WEBService.SeckillAggregateServices.Dto.PaymentService;
using ijlynivfhp.Core.WEBService.SeckillAggregateServices.Dto.ProductService;
using ijlynivfhp.Core.WEBService.SeckillAggregateServices.Forms.OrderService;
using ijlynivfhp.Core.WEBService.SeckillAggregateServices.Models;
using ijlynivfhp.Core.WEBService.SeckillAggregateServices.Models.OrderService;
...
namespace ijlynivfhp.Core.WEBService.SeckillAggregateServices.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        /* /// <summary>
         /// 4.2、创建订单(redis扣减库存 + 消息队列 + 单品限流 + 限制购买数量)
         /// </summary>
         /// <param name="orderDto"></param>
         [HttpPost]
         public PaymentDto CreateOrder(SysUser sysUser, [FromForm]OrderPo orderPo)
