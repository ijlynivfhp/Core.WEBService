...
using ijlynivfhp.Core.WEBService.Commons.Caches;
...
using ijlynivfhp.Core.WEBService.Cores.Proxy.Extentions;
...
using ijlynivfhp.Core.WEBService.UserServices.Context;

namespace ijlynivfhp.Core.WEBService.SeckillAggregateServices
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AssmelyName = "ijlynivfhp.Core.WEBService.SeckillAggregateServices";
