...
namespace ijlynivfhp.Core.WEBService.PaymentServices.Payments
{
    /// <summary>
    /// 支付退款接口
    /// </summary>
    interface IPayRefund
    {
        /// <summary>
        /// 支付订单退款申请
        /// </summary>
        ...
        /// <returns></returns>
        public IDictionary<string, object> Refund(string order_sn, string out_refund_no, string total_fee, string refund_fee);
        ...
        /// 支付订单退款查询
        /// </summary>
        /// <param name="request_map">订单号</param>
        /// <returns></returns>
