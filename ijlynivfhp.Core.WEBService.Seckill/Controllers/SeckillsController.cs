...
using ijlynivfhp.Core.WEBService.Commons.AutoMappers;
using ijlynivfhp.Core.WEBService.Commons.Exceptions;
using ijlynivfhp.Core.WEBService.SeckillServices.Dtos;
using ijlynivfhp.Core.WEBService.SeckillServices.Models;
using ijlynivfhp.Core.WEBService.SeckillServices.Services;
using ijlynivfhp.Core.WEBService.SeckillServices.Vos;
using System;
using System.Collections.Generic;
using System.Linq;

namespace ijlynivfhp.Core.WEBService.SeckillServices.Controllers
{
    /// <summary>
    /// 秒杀服务控制器
    /// </summary>
