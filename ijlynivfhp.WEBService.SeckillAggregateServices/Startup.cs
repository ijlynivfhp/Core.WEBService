...
using ijlynivfhp.WEBService.Commons.Caches;
...
using ijlynivfhp.WEBService.Cores.Middleware.Extentions;
using ijlynivfhp.WEBService.Cores.Proxy.Extentions;
...
namespace ijlynivfhp.WEBService.SeckillAggregateServices
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AssmelyName = "ijlynivfhp.WEBService.SeckillAggregateServices";
